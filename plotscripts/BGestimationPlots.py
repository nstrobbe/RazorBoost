...
if __name__ == '__main__':
    ...
    outputdir = "/afs/cern.ch/work/n/nstrobbe/RazorBoost/GIT/Results/closuretest_20140304/"

    region = "g1Mb0Wg1uW0Ll"
    #region = "g1Mbg1W0Ll_mdPhiHat4"

    inputfile_data = "/afs/cern.ch/work/n/nstrobbe/RazorBoost/GIT/Results/results_20140303_noISR/summary/rzrBoostMC_data.root" # data histograms
    inputfile_totalbg = "/afs/cern.ch/work/n/nstrobbe/RazorBoost/GIT/Results/results_20140303_noISR/rzrBoostMC_bg.root" # data histograms
    inputfile_estimate = "/afs/cern.ch/work/n/nstrobbe/RazorBoost/GIT/Results/closuretest_20140304/BGestimate_"+region+"_QCDWJTTJ.root" # bg estimate histograms
