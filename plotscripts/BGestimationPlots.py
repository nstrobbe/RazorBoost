...
if __name__ == '__main__':
    ...
    for var in vars:
        htitle = "Comparison Data vs BG estimate for SIG box"
        hdict_data = plotTools.ConstructHDict(infile_data.Get("h_"+var+"_g1Mbg1W0Ll"),
        ...
        hdict_bg = plotTools.ConstructHDict(infile_bg.Get("h_"+var+"_g1Mbg1W0Ll"),
