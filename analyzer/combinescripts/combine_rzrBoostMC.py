...
os.system('hadd -f '+dres+'/'+anl+'_VV.root '+dres+'/'+anl+'_WW_*.root '+dres+'/'+anl+'_ZZ_*.root '+dres+'/'+anl+'_WZ_*.root')
...
os.system('hadd -f '+dres+'/'+anl+'_DYJetsToLL.root '+dres+'/'+anl+'_DYJetsToLL_HT*.root')
...
os.system('hadd -f '+dres+'/'+anl+'_bg.root '+dres+'/'+anl+'_QCD.root '+dres+'/'+anl+'_VV.root '+dres+'/'+anl+'_TTJets.root '+dres+'/'+anl+'_WJetsToLNu.root '+dres+'/'+anl+'_Top.root '+dres+'/'+anl+'_ZJetsToNuNu.root '+dres+'/'+anl+'_DYJetsToLL.root '+dres+'/'+anl+'_VVV.root '+dres+'/'+anl+'_TTX.root '+dres+'/'+anl+'_Wbb.root '+dres+'/'+anl+'_DYToCC.root '+dres+'/'+anl+'_DYToBB.root')

os.system('hadd -f '+dres+'/'+anl+'_BGoth.root '+dres+'/'+anl+'_VV.root '+dres+'/'+anl+'_ZJetsToNuNu.root '+dres+'/'+anl+'_DYJetsToLL.root '+dres+'/'+anl+'_VVV.root '+dres+'/'+anl+'_TTX.root '+dres+'/'+anl+'_Wbb.root '+dres+'/'+anl+'_DYToCC.root '+dres+'/'+anl+'_DYToBB.root')
